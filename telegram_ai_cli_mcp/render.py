...
delimiters :mod:`telegram_ai_cli_mcp.untrusted` uses to frame stranger-written
...
#: The delimiters :mod:`telegram_ai_cli_mcp.untrusted` frames stranger-written text

...
:mod:`telegram_ai_cli_mcp.audit` writes down what happened. Nothing in it stops the
...
of any attachment — the one :func:`telegram_ai_cli_mcp.outbox.resolve_outbound`
...
impossible — :meth:`telegram_ai_cli_mcp.plans.PlanStore.claim` is one conditional

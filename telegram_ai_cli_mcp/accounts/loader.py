...
async def build_client(
    ...
    **telethon_kwargs: Any,
    ...
    Raises :class:`~telegram_ai_cli_mcp.errors.SessionLocked` when the auth key is
    already in use, :class:`~telegram_ai_cli_mcp.errors.SessionRevoked` when
    Telegram has discarded it, and
    :class:`~telegram_ai_cli_mcp.errors.AuthRequired` when the session exists but no
    longer authorises.
    """

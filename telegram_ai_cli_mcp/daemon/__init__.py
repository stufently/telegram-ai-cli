...
See :mod:`telegram_ai_cli_mcp.daemon.server` for the concurrency model and
:mod:`telegram_ai_cli_mcp.daemon.service` for why the socket cannot be asked for an

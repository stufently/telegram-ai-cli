...
Everything else in :mod:`telegram_ai_cli_mcp.ops` asks for ``open_account(ctx,
...
async def _call_open(registry: Any, label: str) -> Any:
    ...
    raise AccountNotFound(
        ...
        "telegram_ai_cli_mcp/ops/_client.py is the single place to teach it the real name"
    )

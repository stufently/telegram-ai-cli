...
:func:`telegram_ai_cli_mcp.outbox.resolve_outbound` rather than deciding for itself
...
They live outside :mod:`telegram_ai_cli_mcp.ops.write` because that module is
